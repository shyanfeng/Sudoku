...
extern void test_eliminateNumberFromPeers_should_eliminate_peers_for_row_column_box(void);
...
int main(void)
{
  ...
  RUN_TEST(test_eliminateNumberFromPeers_should_eliminate_peers_for_row_column_box, 286);
  RUN_TEST(test_eliminateNumberFromPeers_given_row_peers_should, 337);
