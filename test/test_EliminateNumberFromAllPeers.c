...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku1_1(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 9, 2, 5);
...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku1_2(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 3, 3, 5);
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 1, 6, 9);
...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku2_2(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 4, 3, 2);
...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku2_3(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 4, 9, 1);
...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku2_5(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 6, 2, 5);
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 5, 5, 9);
...
void test_EliminateNumberFrommAllPeers_for_mock_sudoku2_6(void){
  ...
  _eliminateNumberFromAllPeers_Expect((ARRAY_OF_9_9)square, 8, 4, 4);
